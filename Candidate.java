...
//            lineOut.start();
//            recorder.start();
//            Thread.sleep(Evolve.lengthInMS);
//            recorder.stop();
//            recorder.close();
//            lineOut.stop();
//            Thread.sleep(200);

            writer = new FixedRateMonoWriter();
            synth.add(writer);
...
//            FloatSample fileSamples = SampleLoader.loadFloatSample(readFile);
            ...
            System.out.println("Cutoff freq. = " + (int)cutoffFreq + ", qFactor = " + qValue/10);
...
//        }
    ...
    public static double normaliseAndCompare(float[] targetSamples, float[] candidateSamples) {
        ...
        System.out.println("TS = " + targetSamples);
        System.out.println("CS = " + candidateSamples);
        ...
        System.out.println(420 - Math.sqrt(runningTotal));
    ...
    private static FixedRateMonoWriter writer;
